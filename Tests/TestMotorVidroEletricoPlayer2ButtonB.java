...
public class Robot extends TimedRobot {
  ...
  private CANSparkMax motorNeo = new CANSparkMax(6, MotorType.kBrushless);
  ...
  */                                     
  ...
  public void teleopPeriodic() {
    ...
    else if (xboxController1.getYButton() == true){
      if (encoder.getPosition() < 100) {
        motorNeo.set(0.5);
      }
      else if (encoder.getPosition() >= 100){
        motorNeo.set(-0.5);
      }
    }
    else {
    ...
    if (xboxController2.getBButton() == true){
      victors[4].set(ControlMode.PercentOutput, 1.5);
    }
  }
